...
const mockedTransaction = prisma.$transaction as unknown as ReturnType<
	typeof vi.fn
>;
const _mockedBeerGardenFindFirst = prisma.beerGarden
	.findFirst as unknown as ReturnType<typeof vi.fn>;
const _mockedBeerGardenUpdate = prisma.beerGarden
	.update as unknown as ReturnType<typeof vi.fn>;
const _mockedBeerGardenDelete = prisma.beerGarden
	.delete as unknown as ReturnType<typeof vi.fn>;
const _mockedBeerGardenCreate = prisma.beerGarden
	.create as unknown as ReturnType<typeof vi.fn>;
const _mockedBeerTypeFindUnique = prisma.beerType
	.findUnique as unknown as ReturnType<typeof vi.fn>;
const _mockedPubBeerTypeFindUnique = prisma.pubBeerType
	.findUnique as unknown as ReturnType<typeof vi.fn>;
const _mockedPubBeerTypeDelete = prisma.pubBeerType
	.delete as unknown as ReturnType<typeof vi.fn>;
const _mockedPubBeerTypeUpsert = prisma.pubBeerType
		...
		expect(mockedCount).toHaveBeenCalledWith(
			expect.objectContaining({
				where: expect.objectContaining({
					city: { equals: "Leeds", mode: "insensitive" },
				}),
			}),
		);
	});
...
describe("POST /pubs", () => {
	...
	it("returns early when authentication fails", async () => {
		...
		mockedRequireAuth.mockImplementationOnce((_req, res) => {
...
describe("PATCH /pubs/:id", () => {
	...
	it("removes beer gardens and beer types omitted from payload", async () => {
		const originalPub = {
			...
			beerTypes: [{ beerTypeId: "bt_keep" }, { beerTypeId: "bt_remove" }],
		} as any;
